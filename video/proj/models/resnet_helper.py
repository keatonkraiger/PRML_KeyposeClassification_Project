...
from proj.models.common import drop_path
from proj.models.nonlocal_helper import Nonlocal
from proj.models.operators import SE, Swish
...
class ResStage(nn.Module):
    ...
    Stage of 3D ResNet. It expects to have one or more tensors as input for
        single pathway (C2D, I3D, Slow), and multi-pathway (proj) cases.
        More details can be found here:

        Christoph Feichtenhofer, Haoqi Fan, Jitendra Malik, and Kaiming He.
        "proj networks for video recognition."
