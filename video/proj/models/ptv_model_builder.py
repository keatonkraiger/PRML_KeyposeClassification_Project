...
from proj.models.batchnorm_helper import get_norm
from proj.models.video_model_builder import _POOL1, _TEMPORAL_KERNEL_BASIS
...
from pytorchvideo.models.proj import create_proj
...
class PTVproj(nn.Module):
    def __init__(self, cfg):
        ...
        Args:
            cfg (CfgNode): model building configs, details are in the
                comments of the config file.
        """
        super(PTVproj, self).__init__()

        assert (
            cfg.RESNET.STRIDE_1X1 is False
        ), "STRIDE_1x1 must be True for PTVproj"
        assert (
            cfg.RESNET.TRANS_FUNC == "bottleneck_transform"
        ), f"Unsupported TRANS_FUNC type {cfg.RESNET.TRANS_FUNC} for PTVproj"
    ...
    def _construct_network(self, cfg):
        ...
        head_in_features = stage_dim_in + stage_dim_in // cfg.proj.BETA_INV
        ...
        self.model = create_proj(
            # proj configs.
            proj_channel_reduction_ratio=cfg.proj.BETA_INV,
            proj_conv_channel_fusion_ratio=cfg.proj.FUSION_CONV_CHANNEL_RATIO,
            proj_fusion_conv_kernel_size=(
                cfg.proj.FUSION_KERNEL_SZ,
                1,
                1,
            ),
            proj_fusion_conv_stride=(cfg.proj.ALPHA, 1, 1),
            # Input clip configs.
            ...
            stem_dim_outs=(
                width_per_group,
                width_per_group // cfg.proj.BETA_INV,
            ),
